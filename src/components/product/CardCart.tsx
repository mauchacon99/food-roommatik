...
import {  incrementProductToShoppingCart, decrementProductToShoppingCart } from '@/store/features/shoppingCart/shoppingCartSlice';
					...
					<div className="flex  row-start-4 items-start mb-3 pb-3 ">
						...
						<div className="flex items-center">
							...
							<button 
								...
								onClickCapture={() => dispatch(decrementProductToShoppingCart(product.id))} 
							...
							<button
								onClickCapture={() => dispatch(incrementProductToShoppingCart(product.id))} 
