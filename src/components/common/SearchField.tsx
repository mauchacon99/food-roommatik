    ...
    <div>
      <div className="my-2">
        <label
          ...
          className="mb-2 text-sm font-medium text-gray-900 sr-only dark: "
        >
          Search
        </label>
        <div className="relative">
          ...
          <input
            type="search"
            id="default-search"
            className="block w-full p-3  pl-10 text-sm text-gray-900 bg-base-200 border-none rounded-full"
