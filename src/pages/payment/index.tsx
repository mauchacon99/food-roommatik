...
export default function PagePayment() {
  return (
    <>
      ...
      <div
        className="modal modal-card-credit border-3 border-neutral"
        id="my-modal-2"
      >
        <div className="modal-box">
      ...
      <Container>
        ...
        <div className="mt-6 flex flex-col">
          <h1 className="text-xl font-medium mb-2">Choose a payment method</h1>
      ...
      <div className="sticky bottom-0 left-0 right-0 z-40 shadow-xl ">
        <div className="flex w-full justify-center bg-base-200 p-2  shadow ">
          <div className=" flex w-full items-center justify-center">
            <Link
              href={"/checkout"}
              className="flex w-full lg:w-3/6 transition delay-150 duration-300 ease-in-out rounded-full justify-center items-center text-primary-content bg-primary font-medium text-lg h-12 p-1"
            >
